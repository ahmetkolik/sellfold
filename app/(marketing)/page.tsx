...
import {
  ...
  ShoppingCart, Download, Star, Loader2,
} from "lucide-react";
...
export default function StorePage() {
  ...
  const c = {
    tr: {
      nav: ["Ürünler", "Nasıl çalışır", "S.S.S."], login: "Giriş yap",
      ...
      faq: [
        ...
        { q: "Ödeme TL (₺) ile mi yapılıyor?", a: "Evet, tüm fiyatlar Türk Lirası üzerindendir ve kartından TL olarak tahsil edilir." },
      ],
      finaleH: ["Beğendiğin ürünü", "hemen al."],
      finaleSub: "Güvenli ödeme · Anında e-posta teslimi",
    ...
    en: {
      nav: ["Products", "How it works", "FAQ"], login: "Sign in",
      ...
      faq: [
        ...
        { q: "Are prices in Turkish Lira?", a: "Yes, all prices are in TRY (₺) and your card is charged in Turkish Lira." },
      ],
      finaleH: ["Find your product,", "buy it now."],
      finaleSub: "Secure checkout · Instant email delivery",
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center px-5 lg:px-8">
          ...
          <nav className="ml-auto hidden items-center gap-7 text-sm text-muted-foreground md:flex">
            ...
            <a href="#faq" className="hover:text-foreground transition-colors">{c.nav[2]}</a>
          </nav>
