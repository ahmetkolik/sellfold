...
export const appConfig: AppConfig = {
  ...
  marketing: {
    ...
    faq: [
      ...
      { q: { tr: "Para bana nasıl ulaşıyor?", en: "How do I get paid?" }, a: { tr: "Ödemeler Stripe hesabına doğrudan geçer; Dropcart araya girmez. Ödeme planları ve banka aktarımı Stripe panelinden yönetilir.", en: "Payments go straight to your Stripe account; Dropcart never holds your money. Payouts and bank transfers are managed from your Stripe dashboard." } },
    ],
  },
